...
public class InstalacionResponse {
    ...
    public InstalacionResponse(InstalacionJuego instalacion) {
        this.id_instalacion = instalacion.getId_instalacion();
        this.id_biblioteca = instalacion.getId_biblioteca();
        this.id_videojuego = instalacion.getId_videojuego();
        this.estado = instalacion.getEstado();
        this.tipo_adquisicion = instalacion.getTipo_adquisicion();
    }
